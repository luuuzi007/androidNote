...
public class spUtil {
	...
	public static String getString(Context context, String key,
		...
		if (sharedPreferences == null) {
			...
			Log.i("spUtil", "sharedPreference为空");
		}
			Log.i("spUtil", "sharedPreferences：====" + sharedPreferences + ",key:"
					+ key + ",defaultPassword:" + defaultValue);
			String str = sharedPreferences.getString(key, defaultValue);
			Log.i("spUtil", "从config中拿到的结果str:"+str);
		return str;
	}
	/**
	...
	public static void putString(Context context, String key, String value) {
		...
		// sharedPreferences.edit().putString(ConstantUtil.MOBILESAFE_PASSWORD,
		// passwrod);
		Editor edit = sharedPreferences.edit();
